...
![[Pasted image 20240530151925.png]]
...
Начнем с GitHub - с его помощью можно пушить все изменения сделанные на компе в облако. Я знаю что для Obsidian есть даже плугин который позволяет это делать прямо из приложения. Но лично мне удобнее использовать GiHub Desktop отдельно. 
...
Дале давайте возмемься за [Obsidian](![[Pasted image 20240530153718.png]])
![[Pasted image 20240530153751.png]]
...
***
%%Не уверен что нужно это но если вдруг понадобится.
